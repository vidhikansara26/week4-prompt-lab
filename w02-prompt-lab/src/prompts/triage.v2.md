...
Before you choose queue, write a short analysis (one or two sentences)
that names the competing intents if any, then choose the queue.
...
Required keys: analysis, queue, escalation_required, confidence, rationale,
draft_reply, human_review_required, customer_outcome.
analysis is a short explanation of the routing decision. It does not replace rationale.
